...
$userHash = $_GET['user']; //it will retrieve the userhash from the link;
if($_SERVER['REQUEST_METHOD']==="POST")
{
    $feedback = $_POST['feedback'];//will retrieve the feedback from the user;
    
    $feedbackObj = new Feedback();
    $feedbackObj->saveFeedBack($feedback,$userHash);
            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    <div class="mx-auto w-full max-w-xl text-center">
                        ...
                        <h3 class="text-gray-500 my-2">Want to ask something or share a feedback to "Shahriar Masum"?</h3>
                    </div>
