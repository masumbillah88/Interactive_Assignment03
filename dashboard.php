...
$link = $user->getUniqueLink($userName);
...
<header class="bg-white">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <span class="text-sm font-semibold leading-6 text-gray-900"><?php echo $userName; ?> </span>
            <div>
            <br class="my-2">
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="./logout.php" class="flex items-center text-sm font-semibold leading-6 text-gray-900">
    
    <svg class="h-8 w-8 text-red-500 ml-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="py-6">
                        <span class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Shahriar Masum</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                <div class="relative flex items-center space-x-3 rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
                    <div class="focus:outline-none">
                        ...
                        <p class="text-gray-500"> <?php echo $feedback['feedback'];?>
                        </p>
